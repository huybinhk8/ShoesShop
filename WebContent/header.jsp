	...
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				...
				<li class="payment"><a
					href="<%=request.getContextPath()%>/payment.jsp">Thanh toán</a></li>
				<li class="promotion"><a
					href="<%=request.getContextPath()%>/promotion.jsp">Khuyến mãi</a></li>
				<li class="support"><a
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown"><a class="dropdown-toggle"
					data-toggle="dropdown" href="#"><span
						class="glyphicon glyphicon-globe"></span> Ngôn ngữ
						<span class="caret"></span></a>
					<ul class="dropdown-menu">
						<li><a href="<%=response.encodeURL("Lang?lang=eng")%>">Tiếng anh</a></li>
						<li><a href="<%=response.encodeURL("Lang?lang=vi")%>">Tiếng việt</a></li>
					</ul></li>
			</ul>

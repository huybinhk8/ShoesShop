...
function CheckAuthentication()
{
	...
	if($_SESSION['kt_login_id']==true){
		return isset($_SESSION['kt_login_id']) && $_SESSION['kt_login_id'];
	}else{
		return isset($_SESSION['kh_login_id']) && $_SESSION['kh_login_id'];
	}
	//return false;
}
...
//$LCOR=explode('/scripts',$_SERVER['SCRIPT_NAME']); 
//$baseUrl = $_SERVER['DOCUMENT_ROOT'].$LCOR[0].'/uploads/noidung/';

//$baseUrl = 'http://'.$_SERVER['HTTP_HOST'].$linkroot2.'/uploads/noidung/';
//$baseUrl = 'uploads/noidung/';

$LCOR=explode('/scripts',$_SERVER['SCRIPT_NAME']); 
$baseUrl = 'http://'.$_SERVER['HTTP_HOST'].$LCOR[0].'/uploads/noidung/';
...
*/
//$baseDir = resolveUrl($baseUrl);
//$baseDir = $_SERVER['DOCUMENT_ROOT'].'/'.$linkroot2.'/uploads/noidung/';

$baseDir = $_SERVER['DOCUMENT_ROOT'].$LCOR[0].'/uploads/noidung/';
